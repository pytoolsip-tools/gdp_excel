...
class ParamsViewCtr(object):
	"""docstring for ParamsViewCtr"""
	def __init__(self, parent, params = {}):
		super(ParamsViewCtr, self).__init__();
		self._className_ = ParamsViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = ParamsViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
